...
function Footer() {
  ...
  return (
    <>
      ...
      <div className="bg-[#120F2D] px-6 pb-8 md:px-[10%]">
        {/* Logo */}
        <div className="md:flex justify-between">
          <div className="pt-[6rem] text-white md:w-[55%]">
          ...
          {/* Form email uchun */}
          <div className="pt-12 md:pt-[6rem] md:w-[40%]">
        ...
        <div className="md:flex">
          {/* Aloqaga chiqish */}
          <div className="pt-12 text-white md:w-[50%]">
            <p className="text-2xl font-bold text-white">
          ...
          <div className="pt-12 text-white">
            ...
            <Link to="" className="flex pt-4 text-[#6B6A75]">
